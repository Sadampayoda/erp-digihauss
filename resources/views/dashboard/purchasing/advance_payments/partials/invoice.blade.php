<div class="flex-1 flex-col rounded-xl bg-white shadow px-8 pb-4 lg:mb-2">
    ...
    <div class="flex pt-4 border-t border-slate-200 gap-3">
        <button onclick="submit()" id="advance-payments-modal-button"
            class="
                ...
                cursor-pointer
            ">
            <span class="flex flex-row gap-2 text-sm lg:text-base font-medium btn-text-advance-payments">
                <i data-lucide="save" class="w-5 h-5 transition-transform duration-300 group-hover:rotate-90"></i>
                Simpan
            </span>
        </button>
        <button type="button" id="total-advance-payments-modal-button"
            class="
                group flex items-center justify-center gap-2
