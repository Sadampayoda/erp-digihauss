<div class="flex-1 flex-col rounded-xl bg-white shadow px-8 pb-4 lg:mb-2">
    ...
    <div class="py-8 border-b border-b-slate-300">
        ...
        <p class="text-sm font-medium text-slate-400">
            Informasi pengembalian Barang Vendor
        </p>
    </div>
    ...
    <div class="flex pt-4 border-t border-slate-200 gap-3">
        <button onclick="submit()" id="purchase-returns-modal-button"
            class="
                ...
                cursor-pointer
            ">
            <span class="flex flex-row gap-2 text-sm lg:text-base font-medium btn-text-purchase-return">
                <i data-lucide="save" class="w-5 h-5 transition-transform duration-300 group-hover:rotate-90"></i>
                Simpan
            </span>
        </button>
        <button type="button" id="total-purchase-returns-modal-button"
            class="
                group flex items-center justify-center gap-2
...
<x-summary-form summaryFormModalButton="total-purchase-returns-modal-button" summaryFormModal="total-purchase-returns-modal"
