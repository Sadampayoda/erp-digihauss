...
<x-modal id="receipt-invoices-item-new-modal" title="Tambah Barang Baru" onSubmit="onSubmiItem" typeButton="button">
...
<script>
    const openBtnItemNew = document.getElementById('btn-receipt-invoices-item-new-modal')
    const modalItemNew = document.getElementById('receipt-invoices-item-new-modal')
    ...
    const onSubmiItem = () => {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $('#receipt-invoices-item-new-modal').addClass('hidden').removeClass('flex');
