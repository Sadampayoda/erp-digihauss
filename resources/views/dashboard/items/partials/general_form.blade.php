...
<form id="generalForm">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <x-input-text name="code" label="Item Code" placeholder="IP13-PRO-128-GR" class="rounded-sm p-1 md:p-2"
            border_color="border-stone-300" :required="true" :value="@$data->code" />
